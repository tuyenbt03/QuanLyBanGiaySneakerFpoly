...
public class ExcelHoaDon {
    ...
    public void inHoaDon(HoaDon hoaDon, List<HDCT_CTSP> hdct_ctsp, String pathFile) {
        ...
        try {
            ...
            String ten = "sinchao";
            document.add(new Paragraph(ten));
            float col = 280f;
            ...
            khachHangTable.addCell(new Cell().add(hoaDon.getIdKhachHang().getTenKhachHang()==null?"khachle":hoaDon.getIdKhachHang().getTenKhachHang()).setBorder(Border.NO_BORDER));
            khachHangTable.addCell(new Cell().add("SĐT:").setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.RIGHT));
            khachHangTable.addCell(new Cell().add(hoaDon.getIdKhachHang().getSdt()==null?"khachle":hoaDon.getIdKhachHang().getSdt()).setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.RIGHT));
            khachHangTable.addCell(new Cell().add("Email:").setBorder(Border.NO_BORDER));
            khachHangTable.addCell(new Cell().add(hoaDon.getIdKhachHang().getEmail()==null?"khachle":hoaDon.getIdKhachHang().getEmail()).setBorder(Border.NO_BORDER));
            khachHangTable.addCell(new Cell().add("Địa chỉ:").setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.RIGHT));
            khachHangTable.addCell(new Cell().add(hoaDon.getIdKhachHang().getDiaChi()==null?"khachle":hoaDon.getIdKhachHang().getDiaChi()).setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.RIGHT));
